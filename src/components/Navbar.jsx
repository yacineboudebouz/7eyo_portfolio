    ...
    <nav className={`${styles.paddingX} w-full flex items-center py-5 fixed top-0 z-20 right-0 bg-primary`}>
      <div className='w-full flex justify-between items-center max-w-7xl mx-auto'>
        ...
        >
          ...
          <p className='text-white text-[18px] font-bold cursor-pointer'>Abdelhai <span className=' sm:block hidden'>| Mobile developer</span></p>
        </Link>
        ...
        <div className='sm:hidden flex flex-1 justify-end items-center'>
          <img src={toggle ? menu : close} alt='menu' className='w-[28px] h-[28px] object-contain cursor-pointer duration-200'
